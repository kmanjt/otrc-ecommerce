        ...
        {props.test2 && (
          <div className="relative  ">
            <div className=" backdrop-blur-sm bg-white/40 min-h-screen fixed top-0 left-0 w-full h-full flex justify-center items-center   z-50">
              <div className=" sm:bg-otrc-green/95 container shadow-xl w-full h-full p-4 sm:w-auto sm:h-auto  mx-auto px-11 rounded-xl flex items-center justify-center flex-col ">
                <button
                  className="absolute top-16 right-14 max-w-16 max-h-16 text-white bg-otrc-green/70 sm:text-white/75  text-6xl font-bold rounded-full  flex items-center justify-center hover:bg-red-500 hover:text-white transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110"
                  onClick={props.vis}
                >
                  {" "}
                  <AiFillCloseCircle />{" "}
                ...
                <div className="mx-auto relative">
                  <img
                    src={logo}
                    alt="otrc logo"
                    className=" w-auto h-36 sm:h-40 md:h-40  mx-auto rounded-full"
                  />
                </div>
                ...
                <div className="flex justify-evenly">
                  <Link onClick={props.vis} to="/registration">
                    <p className="text-sm underline text-black sm:text-white  ">
                      sign up now!
                    </p>
                  </Link>
                </div>
